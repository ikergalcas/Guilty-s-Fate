...
public class UI {
	...
	public void generateScene() {
		...
		//createObject(2,440,180,50,50, "Caja.jpg","Abrir1","Correr1","Cerrar1","Salir1","Hablar2","Abrir2","Correr2","Salir2");
		createArrowButton(2,650,150,50,50,"Arrowb.png","goScene1");
